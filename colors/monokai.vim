...
exe "let s:bg_tan        = ' ".s:vmode."bg=".s:tan       ."'"
...
exe "let s:fg_tan        = ' ".s:vmode."fg=".s:tan       ."'"
...
exe "hi! StatusLine"      .s:fg_purple      .s:bg_background  .s:fmt_revr
...
exe "hi! Float"           .s:fg_yellow      .s:bg_none        .s:fmt_none
exe "hi! Boolean"         .s:fg_purple      .s:bg_none        .s:fmt_none
exe "hi! Character"       .s:fg_tan         .s:bg_none        .s:fmt_none
exe "hi! String"          .s:fg_tan         .s:bg_none        .s:fmt_none
